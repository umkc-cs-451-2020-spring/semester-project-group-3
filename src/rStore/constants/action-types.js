...
const FETCH_NOTIFICATION_SETTINGS_SUCCESS  = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const FETCH_NOTIFICATION_SETTINGS_FAILURE  = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const UPDATE_NOTIFICATION_SETTINGS_BEGIN   = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const UPDATE_NOTIFICATION_SETTINGS_SUCCESS = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const UPDATE_NOTIFICATION_SETTINGS_FAILURE = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const DELETE_NOTIFICATION_SETTINGS_BEGIN   = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const DELETE_NOTIFICATION_SETTINGS_SUCCESS = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const DELETE_NOTIFICATION_SETTINGS_FAILURE = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const POST_NOTIFICATION_SETTINGS_BEGIN     = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const POST_NOTIFICATION_SETTINGS_SUCCESS   = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
const POST_NOTIFICATION_SETTINGS_FAILURE   = "FETCH_NOTIFICATION_SETTINGS_BEGIN";
